...
* Active contributing OpenSky users are rewarded with 2000 API request per day. An active user is a user which has and adsb receiver that is at least 30% online in the active month.
