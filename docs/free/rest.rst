...
* Active contributing OpenSky users are rewarded with 2000 API request per day (users who have an adsb receiver that is at least 30% online in the current month).
